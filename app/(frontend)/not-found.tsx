...
export default function NotFound() {
  return (
    <div className="relative min-h-full py-32 flex flex-col items-center justify-center">
      <ImageMedia alt="" fill duoTone priority url="/not-found.webp" className="absolute -bottom-2 -right-2 -top-2 -left-2 object-cover" />
      <div className="container relative z-10 h-full text-center text-white flex flex-col justify-center items-center">
        ...
        <Button asChild variant="secondary" size="lg" className="text-4xl px-8 py-4 font-mono">
          <Link href="/">
            <span>GO TO HOMEPAGE</span>
            <Icon icon="mdi:arrow-forward" className="ml-8 text-[110%] leading-[1em]" />
          </Link>
        </Button>
      </div>
    </div>
