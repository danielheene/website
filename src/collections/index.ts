...
import { MediaAudio } from '@/collections/MediaAudio'
...
export const COLLECTIONS = [BlogCategories, BlogPosts, MediaImages, MediaVideos, MediaDocuments, MediaAudio, Pages, Users, BlogTags]
