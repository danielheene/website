...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_payload_jobs_log_task_slug" AS ENUM('inline', 'createBlurHash', 'createBrightness', 'createPalette');
  CREATE TYPE "public"."enum_payload_jobs_log_state" AS ENUM('failed', 'succeeded');
  CREATE TYPE "public"."enum_payload_jobs_workflow_slug" AS ENUM('generateImageMeta');
  CREATE TYPE "public"."enum_payload_jobs_task_slug" AS ENUM('inline', 'createBlurHash', 'createBrightness', 'createPalette');
  ...
  CREATE TABLE IF NOT EXISTS "_media_v" (
  	...
  	"parent_id" integer,
  	"version_alt" varchar,
  	"version_brightness" numeric,
  	"version_blur_hash" varchar,
  	"version_palette" jsonb,
  ...
  CREATE TABLE IF NOT EXISTS "resume_contact" (
  	...
  	"schedule_button_label" varchar,
  	"schedule_button_href" varchar,
  	"anchor" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_resume_contact_v" (
  	...
  	"version_schedule_button_label" varchar,
  	"version_schedule_button_href" varchar,
  	"version_anchor" varchar,
