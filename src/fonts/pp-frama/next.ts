...
export const PPFrama = localFont({
  ...
  src: [
    ...
    { path: './files/pp-frama-500-normal.woff2', weight: '600', style: 'normal' },
    { path: './files/pp-frama-500-italic.woff2', weight: '600', style: 'italic' },
    { path: './files/pp-frama-700-normal.woff2', weight: '700', style: 'normal' },
    { path: './files/pp-frama-700-italic.woff2', weight: '700', style: 'italic' },
    { path: './files/pp-frama-700-normal.woff2', weight: '800', style: 'normal' },
    { path: './files/pp-frama-700-italic.woff2', weight: '800', style: 'italic' },
