...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded text-sm font-mono font-medium transition-constants disabled:pointer-events-none disabled:opacity-50',
  {
    defaultVariants: {
      size: 'default',
      variant: 'default',
    ...
    variants: {
      ...
      variant: {
        ...
        secondary:
          'bg-white border border-primary text-primary hover:bg-white/80 ',
      },
    },
  },
)
