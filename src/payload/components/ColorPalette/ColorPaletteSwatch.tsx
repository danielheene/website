...
import { ColorPaletteSwatchVibrancy } from '@custom-types'
...
export const ColorPaletteSwatch = memo(function ColorPaletteSwatch({
  vibrancy,
  foreground,
  background,
  name,
  ...
  return (
    <div
      className={styles.ColorPaletteSwatch_Container}
