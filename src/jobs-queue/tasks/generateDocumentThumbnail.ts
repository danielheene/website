...
export const generateDocumentThumbnail: TaskConfig<TaskSlug['GenerateDocumentThumbnail']> = {
  slug: TaskSlug.GenerateDocumentThumbnail,
  label: 'Generate Document Thumbnail',
  retries: 3,
  concurrency: {
    key: ({ input }) => `${TaskSlug.GenerateDocumentThumbnail}:${input.documentId}`,
    exclusive: true,
    supersedes: true,
  },
  inputSchema: [
